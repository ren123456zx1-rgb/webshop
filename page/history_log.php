                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3">
                            <div class="container-fluid <?php echo $bg?> p-4 pt-5 rounded shadow-sm border-ys count-only" style="border-radius: 1vh;">
                                <a href="/backend_topup_history" style="text-decoration: none;">
                                    <center>
                        ...
                        <div class="col-lg-3">
                            <div class="container-fluid <?php echo $bg?> p-4 pt-5 rounded shadow-sm border-ys count-only" style="border-radius: 1vh;">
                                <a href="/backend_buy_history" style="text-decoration: none;">
                                    <center>
                                        <img src="assets/icon/history.png" class="img-fluid mb-3" style="height: 100px;">
                        ...
                        <div class="col-lg-3">
                            <div class="container-fluid <?php echo $bg?> p-4 pt-5 rounded shadow-sm border-ys count-only" style="border-radius: 1vh;">
                                <a href="/backend_app_history" style="text-decoration: none;">
                                    <center>
                                        <img src="assets/icon/history.png" class="img-fluid mb-3" style="height: 100px;">
