<div class="container-sm  <?php echo $bg?> mt-5  shadow-sm p-4 mb-4" data-aos="fade-down">
    ...
    <!-- <div class="d-flex justify-content-between">
        <div>
            <a class="btn btn-primary <?php if(!isset($_GET['item']) || $_GET['item'] == 1){echo"disabled";}?>" href="/nd&type=<?php echo $_GET['type'];?>&item=<?php if(!isset($_GET['item']) || $_GET['item'] == 1){echo"1";}else{echo $_GET['item'] - 1;}?>" >หน้าที่แล้ว</a>
            <a class="text-primary ms-2" href="/nd&type=<?php echo $_GET['type'];?>&item=1" >หน้าแรก</a>
            
        </div>
        <p class="text-primary align-self-center mb-0"><?php echo htmlspecialchars($current_page);?></p>
        <div>
            <a class="text-primary me-2" href="/nd&type=<?php echo $_GET['type'];?>&item=<?php echo $total_pages?>" >หน้าสุดท้าย</a>
            <a class="btn btn-primary <?php if(($current_page + 1) > $total_pages){echo"disabled";}?>" href="/nd&type=<?php echo $_GET['type'];?>&item=<?php echo $current_page + 1;?>">หน้าต่อไป</a>
        </div>
    </div> -->
</div>
