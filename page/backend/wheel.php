...
if (isset($_GET['id'])) {
    ...
    $wheel_id = $_GET['id']; // ไอดีวงล้อที่เลือกอยู่ตอนนี้
?>
    <div class="container-sm <?php echo $bg?> border border-2 mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
        ...
        <div class="table-responsive mt-3 ">
            <table id="table" class="table mt-2">
                ...
                <tbody>
                    <?php
                    $get_user = dd_q("SELECT * FROM wheel_item WHERE w_id = ? ORDER BY id DESC", [$wheel_id]);
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a class="btn btn-warning  w-100 col-4" style="width : 130px!important" href="/stock_wheel?id=<?php echo $row["id"]; ?>"><i class="fa-solid fa-box"></i>&nbsp;สต็อก</a></td>
